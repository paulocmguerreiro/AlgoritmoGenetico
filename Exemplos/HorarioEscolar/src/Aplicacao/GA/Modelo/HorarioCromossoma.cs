...
namespace HorarioEscolar.Applicacao.GA.Modelo
{
    ...
    public class HorarioCromossoma() : ICromossoma<HorarioGene>
    {
        ...
        /// <summary>
        /// Inicializa o cromossoma, limpando os genes e removendo as métricas de fitness e código único, preparando-o para uma nova avaliação ou reutilização em operações genéticas como crossover e mutação.
        /// </summary>
        ...
        /// <summary>
        /// Remove as métricas de fitness e código único, marcando o cromossoma como não avaliado.
        /// </summary>
        public void Reset()
        {
            _fitness = null;
        ...
        /// <summary> Cria uma cópia do cromossoma e de todos os seus genes. </summary>
        public ICromossoma<HorarioGene> Clone() =>
            new HorarioCromossoma
            {
                Fitness = Fitness,
                CodigoUnico = CodigoUnico,
                Genes = Genes.Select(geneOriginal => geneOriginal.Clone()).ToList()
            };


        /// <summary>
        /// Adiciona um gene ao cromossoma, garantindo que ele seja do tipo HorarioGene e atualizando a coleção interna de genes.
        /// </summary>
