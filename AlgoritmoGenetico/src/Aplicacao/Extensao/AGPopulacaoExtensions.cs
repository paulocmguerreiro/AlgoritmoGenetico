...
namespace AlgoritmoGenetico.Aplicacao.Extensao
{
    /// <summary>
    ...
    internal static class AGPopulacaoExtensions
    {
        ...
        /// </summary>
        public static IEnumerable<TCromossoma> OrderByFitness<TCromossoma>(this IEnumerable<TCromossoma> populacao, AGProcessoDeEvolucao processo)
        ...
        /// </summary>
        public static List<TCromossoma> DistinctByFitness<TCromossoma>(this IEnumerable<TCromossoma> populacao)
