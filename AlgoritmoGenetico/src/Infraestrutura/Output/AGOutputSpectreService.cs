...
namespace AlgoritmoGenetico.Infraestrutura.Output
{
    ...
    /// <summary>
    /// Classe base para serviços de output do algoritmo genético utilizando a biblioteca Spectre.Console, fornecendo métodos abstratos para eventos-chave e utilitários para análise de população, além de implementações específicas para visualização de métricas de performance, distribuição de fitness e informações do Garbage Collector.
    /// </summary>
    public abstract class AGOutputSpectreService<TCromossoma> : AGOutputBaseService<TCromossoma> where TCromossoma : ICromossoma<IGene>
    {
        ...
        /// Crucial para monitorizar a saúde da aplicação em execuções longas.
        /// </summary>
        ...
        public Table PerformanceInfo(AG<TCromossoma> ag)
        {
            ...
            singleTable.AddRow("[yellow]População(Genes)[/]", $"{ag.Populacao.Count,5} ({ag.SolucaoCandidata!.Genes.Count() == 0})");
