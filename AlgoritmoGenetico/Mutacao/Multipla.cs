...
namespace AlgoritmoGenetico.Mutacao
{
    ...
    /// </summary>
    public class Multipla<TCromossoma> : Unica<TCromossoma>
    where TCromossoma : ICromossoma<IGene>
    {
        ...
        public override void Mutar(List<TCromossoma> populacao, AGConfiguracao<TCromossoma> configuracao, int geracoesSemEvolucao)
        {
            ...
            populacao.ForEach(individuo =>
            {
                ...
                {
                    configuracao.ProcessarMutacaoCallback(individuo, configuracao);
                }
